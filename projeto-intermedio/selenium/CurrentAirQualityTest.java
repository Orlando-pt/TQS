...
import java.net.URL;
public class CurrentAirQualityTest {
  ...
  public void currentAirQuality() {
    ...
    assertThat(driver.findElement(By.cssSelector("h1")).getText(), is("Current air quality in Porto"));
    {
