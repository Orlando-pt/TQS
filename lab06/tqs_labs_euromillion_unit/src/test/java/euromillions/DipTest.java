...
public class DipTest {
    ...
    public void testConstructorFromBadArrays() {
        ...
        /*
            verifying with 4 numbers and 2 starts
         */
        assertThrows(IllegalArgumentException.class,
                () -> new Dip(new int[]{15, 20, 25, 30}, new int[]{1, 2}),
                "A IllegalArgumentException should be triggered when the Dip constructor does not have 5 numbers and 2 stars");
    }
