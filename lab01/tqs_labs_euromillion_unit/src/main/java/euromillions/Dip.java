...
public class Dip {
    ...
    private static final int MAX_STARTS = 2;
    private static final int MAX_RANGE_NUMBERS = 49;
    private static final int MAX_RANGE_STARTS = 9;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (MAX_NUMBERS == arrayOfNumbers.length && MAX_STARTS == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < MAX_STARTS; ) {
            int candidate = generator.nextInt(MAX_RANGE_STARTS) + 1;
